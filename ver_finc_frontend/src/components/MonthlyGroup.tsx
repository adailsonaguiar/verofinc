        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/10">
            <div className="flex items-center gap-2.5 mb-2">
              <TrendingUp className="w-5 h-5 text-emerald-200" strokeWidth={2} />
              <span className="text-white/90 text-sm font-semibold">Receitas</span>
            </div>
          ...
          <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/10">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <span className="text-white/90 text-sm font-semibold">Despesas</span>
            </div>
            <p className="text-2xl font-bold text-white tracking-tight">
        ...
        <div className="p-6 space-y-3 bg-gradient-to-br from-gray-50 to-white">
          {monthData.transactions.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">Nenhuma transação neste mês</p>
            </div>
          )}
        </div>
      )}
